...
- **Leveza de Hospedagem:** O backend e o banco de dados (SQLite) devem consumir recursos mínimos (CPU/RAM) para viabilizar hospedagem em VPS de baixo custo gerenciada pelo PM2.
