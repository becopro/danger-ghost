...
function RenderGhostdexInNavbar(db) {
    ...
    db.forEach(function(ghost) {
        ...
        if (st < 2) {
            ...
            html += '<div style="margin:4px 0;"><img src="assets/sprites/ghost_' + ghost.id + '_r.webp?v=10" style="width:24px; height:24px; image-rendering:pixelated;" /></div>';
...
window.ShowGhostdexDetail = function(ghostId) {
    ...
    if (st === 1) {
        h += '<img src="assets/sprites/ghost_' + ghost.id + '_r.webp?v=10" style="width:48px; height:48px; image-rendering:pixelated; filter:brightness(0);" />';
    } else {
        h += '<img src="assets/sprites/ghost_' + ghost.id + '_r.webp?v=10" style="width:48px; height:48px; image-rendering:pixelated;" />';
    }
...
window.PlayAsGhost = function(ghostId) {
    ...
    window.g_customPlayerGhostRight.src = 'assets/sprites/ghost_' + ghostId + '_r.webp?v=10';
    
    window.g_customPlayerGhostLeft = new Image();
    window.g_customPlayerGhostLeft.src = 'assets/sprites/ghost_' + ghostId + '_l.webp?v=10';
