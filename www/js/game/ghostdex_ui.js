...
window.PlayAsGhost = function(ghostId) {
    ...
    window.g_customPlayerGhostRight.src = 'assets/sprites/ghost_' + ghostId + '_r.webp?v=16';
    
    window.g_customPlayerGhostLeft = new Image();
    window.g_customPlayerGhostLeft.src = 'assets/sprites/ghost_' + ghostId + '_l.webp?v=16';
