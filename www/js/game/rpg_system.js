    ...
    return {
        ...
        loadLocalStorage: function() {
            try {
                ...
                window.g_customPlayerGhostRight.src = 'assets/sprites/ghost_' + activeGhostId + '_r.webp?v=18';
                if (!window.g_customPlayerGhostLeft) window.g_customPlayerGhostLeft = new Image();
                window.g_customPlayerGhostLeft.src = 'assets/sprites/ghost_' + activeGhostId + '_l.webp?v=18';
