...
window.LoadRPGStateFromDeSo = LoadRPGStateFromDeSo;
        ...
        function SelectCharacterToPlay(charId) {
            ...
            if (char) {
                ...
                var fsBtn = document.getElementById("gameScreenModeBtn");
