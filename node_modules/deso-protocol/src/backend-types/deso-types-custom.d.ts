...
import { DAOCoinLimitOrderSimulatedExecutionResult, DeSoNonce, MsgDeSoTxn, ProfileEntryResponse, SubmitTransactionResponse, TransactionFee, TransactionSpendingLimitResponse } from './deso-types.js';
...
export declare enum OperationTypeWithFee {
    BID = "BID",
    ASK = "ASK"
}
export declare enum FillTypeWithFee {
...
export interface UpdateCoinPropertiesRequest {
    ...
    NewTransferRestrictionStatus: keyof typeof CoinTransferRestrictionStatusByOperation | '';
}
...
export declare enum AMMConfigType {
    NewMarket = "NewMarket",
...
export declare enum AmmOrderStatus {
    None = "None",
    Open = "Open",
    Filled = "Filled",
    Canceled = "Canceled"
