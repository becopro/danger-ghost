...
export interface UtxoView {
    ...
    DAOCoinLimitOrderMapKeyToDAOCoinLimitOrderEntry: Record<string, DAOCoinLimitOrderEntry>;
    TipHash: number[];
    Handle: DB | null;
...
export interface GetNFTBidsForUserResponse {
    ...
    PublicKeyBase58CheckToProfileEntryResponse: Record<string, ProfileEntryResponse>;
...
export interface DAOCoinRequest {
    ...
    CoinsToMintNanos: string;
    CoinsToBurnNanos: string;
    TransferRestrictionStatus: 'unrestricted' | 'profile_owner_only' | 'dao_members_only' | 'permanently_unrestricted';
    MinFeeRateNanosPerKB: number;
    TransactionFees: TransactionFee[] | null;
}
...
export declare enum LockupLimitScopeType {
    ANY = "AnyCoins",
    SCOPED = "ScopedCoins"
}
export declare enum LockupLimitOperationString {
    ANY = "Any",
...
export declare enum HodlersSortType {
...
export type PublicKeyToProfileEntryResponseMap = Record<string, ProfileEntryResponse | null>;
export type PostHashHexToPostEntryResponseMap = Record<string, PostEntryResponse | null>;
...
export interface ValidatorResponse {
    ...
    VotingPublicKey: string;
    VotingAuthorization: string;
    TotalStakeAmountNanos: string;
    Status: string;
    LastActiveAtEpochNumber: number;
    JailedAtEpochNumber: number;
    ExtraData: Record<string, string>;
}
export declare enum StakeRewardMethod {
...
export interface UpdateCoinLockupParamsRequest {
    ...
    LockupTransferRestrictionStatus: string;
    ExtraData: Record<string, string>;
    MinFeeRateNanosPerKB: number;
    TransactionFees: TransactionFee[];
}
export interface CoinLockupTransferRequest {
    ...
    RecipientPublicKeyBase58Check: string;
    UnlockTimestampNanoSecs: number;
    LockedCoinsToTransferBaseUnits: string;
    ExtraData: Record<string, string>;
    MinFeeRateNanosPerKB: number;
    TransactionFees: TransactionFee[];
}
