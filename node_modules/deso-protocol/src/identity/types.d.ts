import { AccessGroupLimitMapItem, AccessGroupMemberLimitMapItem, AssociationLimitMapItem, LockupLimitMapItem, StakeLimitMapItem, TransactionSpendingLimitResponse, TransactionType, UnlockStakeLimitMapItem, UnstakeLimitMapItem } from '../backend-types/index.js';
...
export interface TransactionSpendingLimitResponseOptions {
    ...
    StakeLimitMap?: (Omit<StakeLimitMapItem, 'StakeLimit'> & {
        StakeLimit: string | 'UNLIMITED';
    })[];
    UnstakeLimitMap?: (Omit<UnstakeLimitMapItem, 'UnstakeLimit'> & {
        UnstakeLimit: string | 'UNLIMITED';
    })[];
...
export interface WindowProvider {
    ...
    open: (url: string, title: string | undefined, options: string) => Window | null;
