import { AccessGroupEntryResponse, DecryptedMessageEntryResponse, MsgDeSoTxn, NewMessageEntryResponse, SubmitTransactionResponse, type TransactionSpendingLimitResponse } from '../backend-types/index.js';
...
export declare class Identity<T extends StorageProvider> {
    ...
    submitAtomicTx(IncompleteAtomicTransactionHex: string, SignedInnerTransactionsHex: string[]): Promise<{
