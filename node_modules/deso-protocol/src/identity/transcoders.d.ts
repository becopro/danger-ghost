...
export declare const Varint64: Transcoder<number>;
...
export declare const VarBufferArray: Transcoder<Uint8Array[]>;
...
export declare function BoolOptional<T>(transcoder: Transcoder<T>): Transcoder<T | null>;
