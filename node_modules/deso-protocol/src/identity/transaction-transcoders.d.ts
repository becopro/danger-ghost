...
export declare class TransactionMetadataRegisterAsValidator extends BinaryRecord {
    domains: Uint8Array[];
    disableDelegatedStake: boolean;
    delegatedStakeCommissionBasisPoints: number;
    votingPublicKey: Uint8Array;
    votingAuthorization: Uint8Array;
}
export declare class TransactionMetadataUnregisterAsValidator extends BinaryRecord {
}
export declare class TransactionMetadataStake extends BinaryRecord {
    validatorPublicKey: Uint8Array;
    rewardMethod: number;
    stakeAmountNanos: Uint8Array;
}
export declare class TransactionMetadataUnstake extends BinaryRecord {
    validatorPublicKey: Uint8Array;
    unstakeAmountNanos: Uint8Array;
}
export declare class TransactionMetadataUnlockStake extends BinaryRecord {
    validatorPublicKey: Uint8Array;
    startEpochNumber: number;
    endEpochNumber: number;
}
export declare class TransactionMetadataUnjailValidator extends BinaryRecord {
}
export declare class TransactionMetadataCoinLockup extends BinaryRecord {
    profilePublicKey: Uint8Array;
    recipientPublicKey: Uint8Array;
    unlockTimestampNanoSecs: number;
    vestingEndTimestampNanoSecs: number;
    lockupAmountBaseUnits: Uint8Array;
}
export declare class TransactionMetadataUpdateCoinLockupParams extends BinaryRecord {
    ...
    lockupTransferRestrictionStatus: number;
}
export declare class TransactionMetadataCoinLockupTransfer extends BinaryRecord {
    recipientPublicKey: Uint8Array;
    profilePublicKey: Uint8Array;
    unlockTimestampNanoSecs: number;
    lockedCoinsToTransferBaseUnits: Uint8Array;
}
export declare class TransactionMetadataCoinUnlock extends BinaryRecord {
    profilePublicKey: Uint8Array;
}
export declare const InnerTransactionTypeMetadataMap: {
    ...
    34: typeof TransactionMetadataRegisterAsValidator;
    35: typeof TransactionMetadataUnregisterAsValidator;
    36: typeof TransactionMetadataStake;
    37: typeof TransactionMetadataUnstake;
    38: typeof TransactionMetadataUnlockStake;
    39: typeof TransactionMetadataUnjailValidator;
    40: typeof TransactionMetadataCoinLockup;
    41: typeof TransactionMetadataUpdateCoinLockupParams;
    42: typeof TransactionMetadataCoinLockupTransfer;
    43: typeof TransactionMetadataCoinUnlock;
};
export declare const InnerTransactionTypeToStringMap: {
    [k: number]: string;
};
export declare class InnerTransaction extends BinaryRecord {
    length: number;
    inputs: TransactionInput[];
...
export declare class TransactionMetadataAtomicTxnWrapper extends BinaryRecord {
...
export declare const TransactionTypeMetadataMap: {
    ...
    42: typeof TransactionMetadataCoinLockupTransfer;
    43: typeof TransactionMetadataCoinUnlock;
    44: typeof TransactionMetadataAtomicTxnWrapper;
};
