import { ConstructedTransactionResponse, DeSoNonce, OptionalFeesAndExtraData, RequestOptions, SubmitTransactionResponse, SubmitTransactionAtomicResponse, TransactionFee } from './backend-types/index.js';
 ...
 */
export declare const handleSignAndSubmit: <T = ConstructedTransactionResponse>(endpoint: string, params: OptionalFeesAndExtraData & any, options?: RequestOptions) => Promise<{
 ...
 * @param options options for the request, including whether to broadcast
 */
export declare const handleSignAndSubmitAtomic: <T = ConstructedTransactionResponse>(endpoint: string, params: OptionalFeesAndExtraData & any, options?: RequestOptions) => Promise<{
    constructedTransactionResponse: T & {
